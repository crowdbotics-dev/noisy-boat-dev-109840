"""
Django settings for noisy_boat_dev_109840 project.
...
ROOT_URLCONF = 'noisy_boat_dev_109840.urls'
...
WSGI_APPLICATION = 'noisy_boat_dev_109840.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_boat_dev_109840 API",
    "DESCRIPTION": "API documentation for noisy_boat_dev_109840 App",
    "VERSION": "v1",
}
